...
import {
  enhanceSmartPlaylistsWithRecommendationIndex,
...
export const generateSmartPlaylistsLite = (
  ...
  const assignedArtwork = assignUniqueSmartArtworkSync(withOverrides, songsById);
  return enhanceSmartPlaylistsWithRecommendationIndex(assignedArtwork, songs, onlineSignals, {
    seed,
    discoveryLevel,
    randomnessLevel,
  });
